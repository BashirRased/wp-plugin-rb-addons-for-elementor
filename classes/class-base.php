...
abstract class Base extends Widget_Base {
	 ...
	 * Render rating.
	 *
	 * @param array  $rbelad_settings Rating settings.
	 * @param string $rbelad_rating_id Rating control ID.
	 * @param array  $rbelad_classes Rating CSS classes.
	 */
	protected function render_rating( $rbelad_settings, $rbelad_rating_id = '', $rbelad_classes = array() ) {
		require RBELAD_CONTROLS_RENDER_PATH . 'rating.php';
	}
	 ...
	 * @param string $rbelad_type_id Visual type control ID.
	 * @param string $rbelad_icon_id Icon control ID.
	 * @param string $rbelad_img_id Image control ID.
	 * @param array  $rbelad_classes Visual CSS classes.
	 * @param string $rbelad_prefix Section content prefix.
	 */
	protected function render_icon_img(
		$rbelad_settings,
		$rbelad_type_id = '',
		$rbelad_icon_id = '',
		$rbelad_img_id = '',
		...
		require RBELAD_CONTROLS_RENDER_PATH . 'icon-img.php';
	}
	 ...
	 *
	 * @param array  $rbelad_settings       Widget settings.
	 * @param string $rbelad_select_link_id Link type control ID.
	 *
	 * @return array Link data.
	 */
	protected function render_select_link(
		$rbelad_settings,
		$rbelad_select_link_id
	) {
		/**
		 * Select link render file.
		 *
		 * The required file must return the link data array.
		 */
		return require RBELAD_CONTROLS_RENDER_PATH . 'select-link.php';
	}
}
