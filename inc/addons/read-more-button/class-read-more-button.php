...
/**
 * Read_More_Button class.
 *
 * @package RBELAD_Elementor_Addons
 */
class Read_More_Button extends Base {
	/**
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/read-more-button/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/read-more-button/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/read-more-button/render/design-1.php';
	}
}
