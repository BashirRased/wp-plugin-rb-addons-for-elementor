...
class Site_Title extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/site-title/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/site-title/style/general.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/site-title/render/design-1.php" );
	}
}