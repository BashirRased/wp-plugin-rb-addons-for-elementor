...
class Site_Tagline extends Base {
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/site-tagline/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/site-tagline/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/site-tagline/render/design-1.php';
	}
}
