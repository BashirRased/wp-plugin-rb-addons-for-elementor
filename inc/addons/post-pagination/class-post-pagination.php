...
/**
 * Post_Pagination class.
 *
 * @package RBELAD_Elementor_Addons
 */
class Post_Pagination extends Base {
	/**
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/post-pagination/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/post-pagination/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/post-pagination/render/design-1.php';
	}
}
