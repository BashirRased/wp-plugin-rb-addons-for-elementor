...
class Archive_Title extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/archive-title/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/archive-title/style/general.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/archive-title/render/design-1.php" );
	}
}