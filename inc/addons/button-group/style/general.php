...
// Classes List.
$class_1       = '{{WRAPPER}} {{CURRENT_ITEM}} .rbelad-button-widget-item'; // phpcs:disable WordPress.NamingConventions.PrefixAllGlobals
$class_hover_1 = '{{WRAPPER}} {{CURRENT_ITEM}} .rbelad-button-widget-item:hover'; // phpcs:disable WordPress.NamingConventions.PrefixAllGlobals
$class_focus_1 = '{{WRAPPER}} {{CURRENT_ITEM}} .rbelad-button-widget-item:focus'; // phpcs:disable WordPress.NamingConventions.PrefixAllGlobals
