<?php
/**
 * Button Group widget output - Style 05.
 *
...
foreach ( $settings['rbelad_button_group_general_content_repeater'] as $rbelad_index => $rbelad_item ) {
	...
	$rbelad_btn_item_array[] = sprintf(
		'<a %1$s><span class="rbelad-button-widget-text">%2$s</span><span class="rbelad-button-widget-icon"><i class="fas fa-arrow-right"></i></span></a>',
		$btn_attr,
		$rbelad_btn_text
	);
}
