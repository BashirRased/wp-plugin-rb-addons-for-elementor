...
class Post_Navigation extends Base {
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/post-navigation/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/post-navigation/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/post-navigation/render/design-1.php';
	}
}
