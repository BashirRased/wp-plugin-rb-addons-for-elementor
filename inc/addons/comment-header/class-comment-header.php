 ...
 * @package RBELAD_Elementor_Addons
 */
class Comment_Header extends Base {
	/**
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/comment-header/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/comment-header/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/comment-header/render/design-1.php';
	}
}
