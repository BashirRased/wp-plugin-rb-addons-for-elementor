<?php
/**
 * Tag Meta widget content controls.
 *
...
// Controls variables.
$prefix = 'rbelad_tag_meta_general_content_';
...
// Widgets Buttons.
Utilities::add_library_buttons( $this, 'tag-meta' );
...
$this->add_style_controls(
	...
	array(
		'controls' => array(
			...
			'select_option' => array(
				'id'      => $prefix . 'tag_icon',
				'label'   => esc_html__( 'Tag Icon', 'rb-elementor-addons' ),
				'options' => array(
...
$this->add_style_controls(
	...
	array(
		'controls' => array(
			// Select Option.
			'select_option' => array(
				'id'      => $prefix . 'tag_prefix',
				'label'   => esc_html__( 'Tag Prefix', 'rb-elementor-addons' ),
				'options' => array(
					'none' => esc_html__( 'None', 'rb-elementor-addons' ),
...
$this->add_style_controls(
	...
	array(
		'controls' => array(
			// Select Option.
			'select_option' => array(
				'id'      => $prefix . 'tag_separtor',
				'label'   => esc_html__( 'Tag Separator', 'rb-elementor-addons' ),
				'options' => array(
					'none' => esc_html__( 'None', 'rb-elementor-addons' ),
					'text' => esc_html__( 'Text', 'rb-elementor-addons' ),
					'icon' => esc_html__( 'Icon', 'rb-elementor-addons' ),
...
$this->add_style_controls(
	...
	array(
		'controls' => array(
			...
			'select_option' => array(
				'id'      => $prefix . 'tag_link',
				'label'   => esc_html__( 'Tag Link', 'rb-elementor-addons' ),
				'options' => array(
					'none'    => esc_html__( 'None', 'rb-elementor-addons' ),
