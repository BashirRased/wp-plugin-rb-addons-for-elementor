<?php
/**
 * Tag Meta widget - Icon style controls.
 *
...
// Controls variables.
$prefix = 'rbelad_tag_meta_icon_';
$cls_1  = '{{WRAPPER}} .rbelad-tag-meta-icon';
$cls_2  = $cls_1 . 'i';
$cls_3  = $cls_1 . 'svg';
$cls_4  = $cls_1 . 'img';
...
$this->start_controls_section(
	...
	array(
		...
		'condition' => array(
			'rbelad_tag_meta_general_content_tag_icon!' => 'none',
		),
	)
);
	...
	array(
		'controls' => array(
			...
			'color'                  => array(
				...
				'select_class' => $cls_1,
				'condition'    => array(
					'rbelad_tag_meta_general_content_tag_icon' => 'icon',
				),
			),
			...
			'icon_img_size'          => array(
				...
				'condition'    => array(
					'rbelad_tag_meta_general_content_tag_icon' => 'img',
				),
			),
			'icon_size'              => array(
