...
class Post_Thumbnail extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/post-thumbnail/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/post-thumbnail/style/general.php" );
	}
	...
	protected function __caption_style() {
		require ( RB_ADDONS_WIDGET . "/post-thumbnail/style/caption.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/post-thumbnail/render/design-1.php" );
	}
}