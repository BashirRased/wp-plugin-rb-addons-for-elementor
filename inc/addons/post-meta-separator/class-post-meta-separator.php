...
/**
 * Post_Meta_Separator class.
 *
 * @package RBELAD_Elementor_Addons
 */
class Post_Meta_Separator extends Base {
	/**
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/post-meta-separator/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/post-meta-separator/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/post-meta-separator/render/design-1.php';
	}
}
