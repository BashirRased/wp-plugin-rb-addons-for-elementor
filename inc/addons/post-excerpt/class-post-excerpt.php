...
class Post_Excerpt extends Base {
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/post-excerpt/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/post-excerpt/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/post-excerpt/render/design-1.php';
	}
}
