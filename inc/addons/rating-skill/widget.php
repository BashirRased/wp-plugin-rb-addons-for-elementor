...
class Rating_Skill extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/rating-skill/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/rating-skill/style/general.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/rating-skill/render/design-1.php" );
	}
}