...
class Site_Logo extends Base {
	...
	protected function __general_content() {
		require RBELAD_WIDGETS . '/site-logo/content/general.php';
	}
	...
	protected function __general_style() {
		require RBELAD_WIDGETS . '/site-logo/style/general.php';
	}
	...
	protected function render() {
		require RBELAD_WIDGETS . '/site-logo/render/design-1.php';
	}
}
