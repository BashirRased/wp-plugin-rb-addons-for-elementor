...
printf(
	'<div %1$s><a %2$s><span class="rbelad-button-widget-text">%3$s</span><span class="rbelad-button-widget-icon"><i class="fas fa-arrow-right"></i></span></a></div>',
