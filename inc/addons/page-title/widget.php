...
class Page_Title extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/page-title/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/page-title/style/general.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/page-title/render/design-1.php" );
	}
}