<?php
/**
 * Contact Form widget - Input Placeholder style controls.
 *
...
// Controls variables.
$prefix = 'rbelad_contact_form_placeholder_';
$cls_1  = '{{WRAPPER}} .wpcf7-form-control::placeholder, {{WRAPPER}} .wpcf7-form-control::-webkit-input-placeholder';
$cls_2  = '{{WRAPPER}} .wpcf7-form-control:focus::placeholder, {{WRAPPER}} .wpcf7-form-control:focus::-webkit-input-placeholder';
