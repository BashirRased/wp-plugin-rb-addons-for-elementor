...
class Contact_Form extends Base {
	...
	protected function __general_content() {
		require ( RB_ADDONS_WIDGET . "/contact-form/content/general.php" );
	}
	...
	protected function __general_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/general.php" );
	}
	...
	protected function __input_textarea_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/input-textarea.php" );
	}
	...
	protected function __input_icon_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/input-icon.php" );
	}
	...
	protected function __label_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/label.php" );
	}
	...
	protected function __placeholder_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/placeholder.php" );
	}
	...
	protected function __submit_btn_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/submit-btn.php" );
	}
	...
	protected function __error_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/error.php" );
	}
	...
	protected function __after_submit_style() {
		require ( RB_ADDONS_WIDGET . "/contact-form/style/after-submit.php" );
	}
	...
	protected function render() {
		require ( RB_ADDONS_WIDGET . "/contact-form/render/design-1.php" );
	}
}