<?php
namespace RB_Elementor_Addons\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'rb-elementor-addons' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'rb-elementor-addons' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'rb-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'rb-elementor-addons' ),
			]
		);
