...
$rbelad_base_id    = ! empty( $rbelad_values['id'] ) ? $rbelad_values['id'] : 'height_width';
$rbelad_size_unit  = ! empty( $rbelad_values['size_unit'] ) ? $rbelad_values['size_unit'] : rbelad_slider_unit();
$rbelad_size_range = ! empty( $rbelad_values['size_range'] ) ? $rbelad_values['size_range'] : rbelad_slider_range();
...
$this->add_control(
	...
	array(
		'label'       => ! empty( $rbelad_values['heading_label'] ) ? $rbelad_values['heading_label'] : esc_html__( 'Height & Width Controls', 'rb-addons-for-elementor' ),
		'label_block' => true,
