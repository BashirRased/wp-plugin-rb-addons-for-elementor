<?php
/**
 * Appsero integration file.
 *
 * Handles licensing, updates, and analytics.
 *
...
class Client {
	 ...
	 * @param bool   $blocking Whether the request is blocking. Default false.
	 *
	 * @return array|\WP_Error Array of results including HTTP headers, or WP_Error if the request failed.
	 */
	public function send_request( array $params, string $route, bool $blocking = false ) {
		$rbelad_url = $this->endpoint() . $route;
	 ...
	 */
	// phpcs:ignore
	public function _etrans( string $text ): void {
	 ...
	 */
	// phpcs:ignore
	public function __trans( string $text ): string {
		return (string) call_user_func( '__', $text, $this->textdomain );
	}
