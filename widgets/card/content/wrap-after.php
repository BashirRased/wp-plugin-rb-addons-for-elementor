...
$this->add_content_controls(
	...
	array(
		'controls' => array(
			// Icon.
			'icon_img'    => array(
				'id'      => $rbelad_prefix . '_card_after_icon_img',
			...
			// Icon Image.
			'img'         => array(
				'id'        => $rbelad_prefix . '_card_after_img',
				'label'     => esc_html__( 'Icon Image', 'rb-addons-for-elementor' ),
				'condition' => array(
					$rbelad_prefix . '_card_after_icon_img' => 'image',
				),
			),

			// Icon.
			'icon_simple' => array(
				'id'               => $rbelad_prefix . '_card_after_icon_simple',
				'label'            => esc_html__( 'Icon', 'rb-addons-for-elementor' ),
				'fa4compatibility' => $rbelad_prefix . '_card_after_icon',
				...
				'condition'        => array(
					$rbelad_prefix . '_card_after_icon_img' => 'icon',
				),
			),
		),
	),
