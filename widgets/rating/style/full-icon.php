...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'full_icon' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-rating__icon--full';
...
$this->start_controls_section(
	$rbelad_prefix,
	array(
		'label' => esc_html__( 'Full Icon', 'rb-addons-for-elementor' ),
