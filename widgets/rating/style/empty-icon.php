...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'empty_icon' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-rating__icon--empty';
...
$this->start_controls_section(
	$rbelad_prefix,
	array(
		'label' => esc_html__( 'Empty Icon', 'rb-addons-for-elementor' ),
