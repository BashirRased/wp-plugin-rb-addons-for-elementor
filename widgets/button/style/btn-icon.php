...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'btn_icon' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-button__link .rbelad-button__icon';
$rbelad_class_2 = '{{WRAPPER}} .rbelad-button__link:hover .rbelad-button__icon, {{WRAPPER}} .rbelad-button__link:focus .rbelad-button__icon';
$rbelad_class_3 = '{{WRAPPER}} .rbelad-button__link:hover .rbelad-button__icon svg, {{WRAPPER}} .rbelad-button__link:hover .rbelad-button__icon i, {{WRAPPER}} .rbelad-button__link:focus .rbelad-button__icon svg, {{WRAPPER}} .rbelad-button__link:focus .rbelad-button__icon i';
