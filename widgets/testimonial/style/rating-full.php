...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'ratting-full' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-testimonial__rating--full';

// Start Section Tab - Style.
$this->start_controls_section(
	$rbelad_prefix,
	array(
		'label' => esc_html__( 'Ratting Full', 'rb-addons-for-elementor' ),
