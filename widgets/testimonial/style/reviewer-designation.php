...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'designation' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-testimonial__designation';

// Start Section Tab - Style.
$this->start_controls_section(
	$rbelad_prefix,
	array(
		'label' => esc_html__( 'Designation', 'rb-addons-for-elementor' ),
