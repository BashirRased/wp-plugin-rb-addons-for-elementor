...
// Controls variables.
$rbelad_prefix  = $this->get_section_style_prefix( 'ratting-half' );
$rbelad_class_1 = '{{WRAPPER}} .rbelad-testimonial__rating--half';

// Start Section Tab - Style.
$this->start_controls_section(
	$rbelad_prefix,
	array(
		'label' => esc_html__( 'Ratting Half', 'rb-addons-for-elementor' ),
