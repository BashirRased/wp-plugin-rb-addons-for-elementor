...
Copyright 2026 Bashir Rased <https://bashir-rased.dev/>
*/
...
if ( defined( 'RBELAD_VERSION_DEV' ) && true === RBELAD_VERSION_DEV ) {
	define( 'RBELAD_VERSION', '2.0.2' . time() );
} else {
	define( 'RBELAD_VERSION', '2.0.2' );
}
...
define( 'RBELAD_JS_PATH', RBELAD_PATH . 'assets/js/' );
define( 'RBELAD_JS_URL', RBELAD_URL . 'assets/js/' );
...
define( 'RBELAD_CONTROLS_STYLE_PATH', RBELAD_PATH . 'global/style/' );
define( 'RBELAD_CONTROLS_STYLE_URL', RBELAD_URL . 'global/style/' );

define( 'RBELAD_CONTROLS_CONTENT_PATH', RBELAD_PATH . 'global/content/' );
define( 'RBELAD_CONTROLS_CONTENT_URL', RBELAD_URL . 'global/content/' );

define( 'RBELAD_CONTROLS_RENDER_PATH', RBELAD_PATH . 'global/render/' );
define( 'RBELAD_CONTROLS_RENDER_URL', RBELAD_URL . 'global/render/' );

define( 'RBELAD_CONTROLS_FUNCTIONS_PATH', RBELAD_PATH . 'global/functions/' );
define( 'RBELAD_CONTROLS_FUNCTIONS_URL', RBELAD_URL . 'global/functions/' );

define( 'RBELAD_ADMIN_PATH', trailingslashit( RBELAD_PATH . 'admin/' ) );
define( 'RBELAD_ADMIN_URL', trailingslashit( RBELAD_URL . 'admin/' ) );

define( 'RBELAD_EXTENDS_PATH', trailingslashit( RBELAD_PATH . 'extends/' ) );
define( 'RBELAD_EXTENDS_URL', trailingslashit( RBELAD_URL . 'extends/' ) );
...
function rbelad_let_the_journey_begin() {
	include_once RBELAD_CONTROLS_FUNCTIONS_PATH . 'global-functions.php';
	include_once RBELAD_CONTROLS_FUNCTIONS_PATH . 'allow-tag-functions.php';
	include_once RBELAD_CONTROLS_FUNCTIONS_PATH . 'content-options-functions.php';
	include_once RBELAD_EXTENDS_PATH . 'container-background-overlay.php';
	include_once RBELAD_EXTENDS_PATH . 'container-background-size.php';
...
function rbelad_elementor_missing_notice() {
	...
	if ( file_exists( WP_PLUGIN_DIR . '/elementor/elementor.php' ) ) {
		...
		$notice_title = esc_html__( 'Install Elementor', 'rb-addons-for-elementor' );
